...
export const REQUIRED_IMAGE_REFS = [
  ...
  { source: 'docker-compose.prod.yml:252', image: 'redis:7-alpine' },
  { source: 'docker-compose.prod.yml:288', image: 'mysql:8.4' },
  { source: 'docker-compose.prod.yml:416', image: 'prom/prometheus:v2.55.1' },
  { source: 'docker-compose.prod.yml:440', image: 'prom/alertmanager:v0.27.0' },
  { source: 'docker-compose.prod.yml:478', image: 'grafana/grafana:11.4.0' },
  { source: 'docker-compose.prod.yml:504', image: 'openzipkin/zipkin:3.4' },
