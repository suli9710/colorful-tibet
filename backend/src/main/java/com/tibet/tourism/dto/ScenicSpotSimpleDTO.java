...
public class ScenicSpotSimpleDTO {
    ...
    public ScenicSpotSimpleDTO(Long id, String name, String description, String imageUrl, String altitude, String location, ScenicSpot.Category category, BigDecimal ticketPrice, BigDecimal rating, BigDecimal latitude, BigDecimal longitude, Integer visitCount, LocalDateTime createdAt) {
        this.id = id;
        this.name = name;
    ...
    // 从实体类转换的静态方法
    public static ScenicSpotSimpleDTO fromEntity(ScenicSpot spot) {
        ScenicSpotSimpleDTO dto = new ScenicSpotSimpleDTO();
