...
import com.tibet.tourism.entity.BehaviorLog;
import com.tibet.tourism.repository.BehaviorLogRepository;
...
public class RiskAssessmentService {
    ...
    public RiskResult assess(String recaptchaToken, String fingerprint,
        ...
        try {
            recaptchaScore = recaptchaFuture.join();
        ...
        log.info("Antibot assessment: endpoint={} user={} fp={} score={} decision={}",
                ...
                String.format("%.1f", weightedScore), decision);
        ...
        CompletableFuture.runAsync(() -> persistLog(
                userId, endpoint, fingerprint, m, captchaScore, weightedScore, decision), executor);
