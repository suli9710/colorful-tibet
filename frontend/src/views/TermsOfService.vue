      ...
      <div class="tibet-panel rounded-2xl p-8 md:p-12 space-y-8">
        ...
        >
          ...
          <div class="space-y-4 text-gray-700">
            ...
            <ul v-if="section.list?.length" class="list-disc list-inside space-y-2 ml-4">
              <li v-for="item in section.list" :key="item">{{ item }}</li>
            </ul>

            <p v-if="section.footer" class="leading-relaxed mt-4">{{ section.footer }}</p>
...
const sections = computed(() => tm('terms.sections') as LegalSection[])
</script>
